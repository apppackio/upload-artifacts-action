...
var AWS_TEMPLATE = "codebuild.{region}.amazonaws.com";
var AWS_CN_TEMPLATE = "codebuild.{region}.amazonaws.com.cn";
var AWS_ISO_TEMPLATE = "codebuild.{region}.c2s.ic.gov";
var AWS_ISO_B_TEMPLATE = "codebuild.{region}.sc2s.sgov.gov";
var AWS_US_GOV_TEMPLATE = "codebuild.{region}.amazonaws.com";
// Partition regions
...
export var defaultRegionInfoProvider = function (region, options) {
    ...
    return Promise.resolve(__assign({ signingService: "codebuild" }, regionInfo));
};
