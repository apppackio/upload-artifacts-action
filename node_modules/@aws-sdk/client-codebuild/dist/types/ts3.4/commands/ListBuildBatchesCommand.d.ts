...
export declare type ListBuildBatchesCommandInput = ListBuildBatchesInput;
export declare type ListBuildBatchesCommandOutput = ListBuildBatchesOutput & __MetadataBearer;
/**
